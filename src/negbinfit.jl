...
"""
negbin(X::AbstractMatrix, y::AbstractVector, l::Union{Link,Nothing}=nothing;
       initialθ::Real=Inf,
...
negbin(formula::FormulaTerm, data, l::Union{Link,Nothing}=nothing;
       initialθ::Real=Inf,
       offset::Union{AbstractVector{<:Real},Nothing}=nothing,
